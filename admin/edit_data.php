...
if (isset($_POST['hapus_tanggapan'])) { 
    ...
    if ($query) {
        echo " <script>
            alert('Data tanggapan berhasil dihapus!');
            window.location.assign('index.php?page=tanggapan');
        </script>
        ";
    }
...
if (isset($_POST['hapus_petugas'])) { 
    ...
    if ($query) { 
        echo " <script>
            ...
            window.location.assign('index.php?page=petugas');
        </script>
        ";
    }
...
if (isset($_POST['hapus_masyarakat'])) { 
    ...
    if ($query) {
        echo " <script>
            ...
            window.location.assign('index.php?page=masyarakat');
        </script>
        ";
    }
