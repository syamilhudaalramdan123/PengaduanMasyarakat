                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $echo_query = mysqli_query($koneksi,"SELECT a.*,b.* FROM pengaduan a INNER JOIN masyarakat b ON a.nik=b.nik ORDER BY id_pengaduan DESC");
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#verifikasi<?php echo $data['id_pengaduan']?>">
                                        VERIFIKASI
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="index.php?page=pengaduan" method="POST">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="btnVerifikasi" class="btn btn-primary">Verifikasi</button>
                                                </div>
                                                </form>
                                                    <?php
                                                        if (isset($_POST['btnVerifikasi'])) {
                                                            ...
                                                            $updatequery = mysqli_query($koneksi,"UPDATE pengaduan SET status='$status' WHERE id_pengaduan='$id_pengaduan' ");
                                                            echo " <script>
                                                            alert('Data Berhasil diverifikasi!');
                                                            window.location.assign('index.php?page=pengaduan');
                                                            </script>
                                                            ";
                                                        }
                                                    ?>
